...
\label{consecu}
\noindent 1) Unicidad del 0 y del 1. Unicidad significa que existe solo un elemento dentro del conjunto, más específicamente, hay un solo elemento que cumple la acción del cero (elemento absorbente) y el uno (elemento neutro). \\
...
Una propiedad importante que se cumple en los porcentajes es ocupando la conmutativa de la multiplicación\footnote{Propiedad conmutativa: Tanto en la suma como en la multiplicación si se cambia el orden de los factores, el resultado será el mismo}. Se puede decir que el $A\%$ de $B$ es igual a $B\%$ de $A$. 
\begin{eqnarray*}
...
Con las fórmulas de porcentaje se puede obtener diferente información desde un mismo problema según lo que uno necesite, pero siempre considerando que si son porcentajes complementarios deben sumar $100\%$.\\
...
\noindent 11) $$ a\cdot b<0 \Leftrightarrow \left\{\begin{array}{ll}
a>0 \wedge b<0\\
\vee \\
a<0 \wedge b>0
\end{array} \right.$$
...
\begin{center}
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.35]{intervalos0.png}
...
\begin{center}
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.35]{abscorrido.png}
...
\noindent 3)  $\forall a,b\in\mathbb{R}$, $|a\cdot b|=|a|\cdot|b|$  \\
\begin{myexample}
\begin{eqnarray*}
|5\cdot 3|=|5|\cdot |3|= 5\cdot 3= 15
\end{eqnarray*}
\end{myexample}
\noindent 4) $\forall a\in\mathbb{R}$, $|-a|=|a|$ \\
\begin{myexample}
\begin{eqnarray*}
|5|=|-5|=5
\end{eqnarray*}
...
\begin{center}
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.65]{abs0.png}
...
\begin{center}
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.6]{abs1.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.25]{casoscuad.png}
...
\subsection{fórmulas de factorización}
\label{facto}
\begin{eqnarray}
